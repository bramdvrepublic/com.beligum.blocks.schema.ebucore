...
public class ImageFormatType {
    ...
    protected List<com.beligum.blocks.schema.ebucore.jaxb.String> technicalAttributeString;
    ...
    protected List<com.beligum.blocks.schema.ebucore.jaxb.Boolean> technicalAttributeBoolean;
     ...
     * {@link com.beligum.blocks.schema.ebucore.jaxb.String }
     * 
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.jaxb.String> getTechnicalAttributeString() {
        if (technicalAttributeString == null) {
            technicalAttributeString = new ArrayList<com.beligum.blocks.schema.ebucore.jaxb.String>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.beligum.blocks.schema.ebucore.jaxb.Boolean }
     * 
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.jaxb.Boolean> getTechnicalAttributeBoolean() {
        if (technicalAttributeBoolean == null) {
            technicalAttributeBoolean = new ArrayList<com.beligum.blocks.schema.ebucore.jaxb.Boolean>();
        }
