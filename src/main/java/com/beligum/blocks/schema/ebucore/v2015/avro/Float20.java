...
public class Float20 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Float20.Builder newBuilder() {
    return new Float20.Builder();
  }
  
  /** Creates a new Float20 RecordBuilder by copying an existing Builder */
  public static Float20.Builder newBuilder(Float20.Builder other) {
    return new Float20.Builder(other);
  }
  
  /** Creates a new Float20 RecordBuilder by copying an existing Float20 instance */
  public static Float20.Builder newBuilder(Float20 other) {
    return new Float20.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Float20>
    ...
    private Builder() {
      super(Float20.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Float20.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Float20.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Float20.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Float20.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Float20.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Float20.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Float20.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Float20.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Float20.Builder clearUnit() {
      unit = null;
