...
public class AudioProgrammeType {
    ...
    protected List<JAXBElement<String>> audioContentIDRef;
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioContentIDRef() {
        if (audioContentIDRef == null) {
            audioContentIDRef = new ArrayList<JAXBElement<String>>();
        }
