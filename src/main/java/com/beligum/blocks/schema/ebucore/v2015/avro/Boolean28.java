...
public class Boolean28 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Boolean28(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new Boolean28 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder();
  }
  
  /** Creates a new Boolean28 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder(other);
  }
  
  /** Creates a new Boolean28 RecordBuilder by copying an existing Boolean28 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder(other);
  }
  
  /**
   * RecordBuilder for Boolean28 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean28>
    implements org.apache.avro.data.RecordBuilder<Boolean28> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Boolean28 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean28.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public Boolean28 build() {
      try {
        Boolean28 record = new Boolean28();
