...
public class Boolean7 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Boolean7(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new Boolean7 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder();
  }
  
  /** Creates a new Boolean7 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder(other);
  }
  
  /** Creates a new Boolean7 RecordBuilder by copying an existing Boolean7 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder(other);
  }
  
  /**
   * RecordBuilder for Boolean7 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean7>
    implements org.apache.avro.data.RecordBuilder<Boolean7> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Boolean7 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean7.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public Boolean7 build() {
      try {
        Boolean7 record = new Boolean7();
