...
public class Int32 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Int32.Builder newBuilder() {
    return new Int32.Builder();
  }
  
  /** Creates a new Int32 RecordBuilder by copying an existing Builder */
  public static Int32.Builder newBuilder(Int32.Builder other) {
    return new Int32.Builder(other);
  }
  
  /** Creates a new Int32 RecordBuilder by copying an existing Int32 instance */
  public static Int32.Builder newBuilder(Int32 other) {
    return new Int32.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Int32>
    ...
    private Builder(Int32.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Int32.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Int32.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Int32.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Int32.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Int32.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Int32.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Int32.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Int32.Builder clearUnit() {
      unit = null;
