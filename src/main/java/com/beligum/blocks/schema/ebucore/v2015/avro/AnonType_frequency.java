...
public class AnonType_frequency extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AnonType_frequency() {}

  /**
   * All-args constructor.
   */
  public AnonType_frequency(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new AnonType_frequency RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder();
  }
  
  /** Creates a new AnonType_frequency RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder(other);
  }
  
  /** Creates a new AnonType_frequency RecordBuilder by copying an existing AnonType_frequency instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder(other);
  }
  
  /**
   * RecordBuilder for AnonType_frequency instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AnonType_frequency>
    implements org.apache.avro.data.RecordBuilder<AnonType_frequency> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing AnonType_frequency instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.AnonType_frequency.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public AnonType_frequency build() {
      try {
        AnonType_frequency record = new AnonType_frequency();
