...
public class Float17 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Float17.Builder newBuilder() {
    return new Float17.Builder();
  }
  
  /** Creates a new Float17 RecordBuilder by copying an existing Builder */
  public static Float17.Builder newBuilder(Float17.Builder other) {
    return new Float17.Builder(other);
  }
  
  /** Creates a new Float17 RecordBuilder by copying an existing Float17 instance */
  public static Float17.Builder newBuilder(Float17 other) {
    return new Float17.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Float17>
    ...
    private Builder() {
      super(Float17.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Float17.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Float17.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Float17.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Float17.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Float17.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Float17.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Float17.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Float17.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Float17.Builder clearUnit() {
      unit = null;
