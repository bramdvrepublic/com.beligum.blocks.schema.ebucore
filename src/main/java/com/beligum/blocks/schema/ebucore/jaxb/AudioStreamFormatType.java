...
public class AudioStreamFormatType {
    ...
    protected List<JAXBElement<String>> audioChannelFormatIDRef;
    ...
    protected List<JAXBElement<String>> audioTrackFormatIDRef;
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioChannelFormatIDRef() {
        if (audioChannelFormatIDRef == null) {
            audioChannelFormatIDRef = new ArrayList<JAXBElement<String>>();
        }
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioTrackFormatIDRef() {
        if (audioTrackFormatIDRef == null) {
            audioTrackFormatIDRef = new ArrayList<JAXBElement<String>>();
        }
