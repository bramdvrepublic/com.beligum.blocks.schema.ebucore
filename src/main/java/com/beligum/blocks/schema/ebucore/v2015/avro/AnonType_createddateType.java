...
public class AnonType_createddateType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AnonType_createddateType.Builder newBuilder() {
    return new AnonType_createddateType.Builder();
  }
  
  /** Creates a new AnonType_createddateType RecordBuilder by copying an existing Builder */
  public static AnonType_createddateType.Builder newBuilder(AnonType_createddateType.Builder other) {
    return new AnonType_createddateType.Builder(other);
  }
  
  /** Creates a new AnonType_createddateType RecordBuilder by copying an existing AnonType_createddateType instance */
  public static AnonType_createddateType.Builder newBuilder(AnonType_createddateType other) {
    return new AnonType_createddateType.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AnonType_createddateType>
    ...
    private Builder() {
      super(AnonType_createddateType.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(AnonType_createddateType.Builder other) {
      super(other);
    ...
    private Builder(AnonType_createddateType other) {
            super(AnonType_createddateType.SCHEMA$);
      if (isValidValue(fields()[0], other.startYear)) {
        this.startYear = data().deepCopy(fields()[0].schema(), other.startYear);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'startYear' field */
    public AnonType_createddateType.Builder setStartYear(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearStartYear() {
      startYear = null;
    ...
    /** Sets the value of the 'startDate' field */
    public AnonType_createddateType.Builder setStartDate(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearStartDate() {
      startDate = null;
    ...
    /** Sets the value of the 'startTime' field */
    public AnonType_createddateType.Builder setStartTime(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearStartTime() {
      startTime = null;
    ...
    /** Sets the value of the 'endYear' field */
    public AnonType_createddateType.Builder setEndYear(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearEndYear() {
      endYear = null;
    ...
    /** Sets the value of the 'endDate' field */
    public AnonType_createddateType.Builder setEndDate(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearEndDate() {
      endDate = null;
    ...
    /** Sets the value of the 'endTime' field */
    public AnonType_createddateType.Builder setEndTime(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearEndTime() {
      endTime = null;
    ...
    /** Sets the value of the 'period' field */
    public AnonType_createddateType.Builder setPeriod(java.lang.CharSequence value) {
    ...
    public AnonType_createddateType.Builder clearPeriod() {
      period = null;
