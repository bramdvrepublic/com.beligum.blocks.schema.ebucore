...
public class Boolean25 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Boolean25(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new Boolean25 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder();
  }
  
  /** Creates a new Boolean25 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder(other);
  }
  
  /** Creates a new Boolean25 RecordBuilder by copying an existing Boolean25 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder(other);
  }
  
  /**
   * RecordBuilder for Boolean25 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean25>
    implements org.apache.avro.data.RecordBuilder<Boolean25> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Boolean25 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean25.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public Boolean25 build() {
      try {
        Boolean25 record = new Boolean25();
