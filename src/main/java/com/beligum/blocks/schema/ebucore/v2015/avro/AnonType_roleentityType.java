...
public class AnonType_roleentityType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.lang.CharSequence costCentre;
   ...
   */
  public AnonType_roleentityType() {}

  /**
   * All-args constructor.
   */
  public AnonType_roleentityType(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage, java.lang.CharSequence costCentre) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: costCentre = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'costCentre' field.
   */
  public java.lang.CharSequence getCostCentre() {
    return costCentre;
  }
   ...
   * @param value the value to set.
   */
  public void setCostCentre(java.lang.CharSequence value) {
  ...
  /**
   * RecordBuilder for AnonType_roleentityType instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AnonType_roleentityType>
    implements org.apache.avro.data.RecordBuilder<AnonType_roleentityType> {
    ...
    private java.lang.CharSequence costCentre;
    ...
    private Builder(AnonType_roleentityType.Builder other) {
      ...
      if (isValidValue(fields()[6], other.costCentre)) {
        this.costCentre = data().deepCopy(fields()[6].schema(), other.costCentre);
    ...
    /** Checks whether the 'costCentre' field has been set */
    public boolean hasCostCentre() {
    ...
    @Override
    public AnonType_roleentityType build() {
      try {
        AnonType_roleentityType record = new AnonType_roleentityType();
        ...
        record.costCentre = fieldSetFlags()[6] ? this.costCentre : (java.lang.CharSequence) defaultValue(fields()[6]);
        return record;
      } catch (Exception e) {
