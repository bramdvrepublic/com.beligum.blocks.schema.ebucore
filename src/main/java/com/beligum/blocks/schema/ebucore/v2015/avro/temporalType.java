...
public class temporalType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> PeriodOfTime;
   ...
   */
  public temporalType(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage, java.lang.CharSequence note, java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> PeriodOfTime) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: PeriodOfTime = (java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'PeriodOfTime' field.
   */
  public java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> getPeriodOfTime() {
    return PeriodOfTime;
  }

  /**
   * Sets the value of the 'PeriodOfTime' field.
   * @param value the value to set.
   */
  public void setPeriodOfTime(java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> value) {
    this.PeriodOfTime = value;
  }

  /** Creates a new temporalType RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder();
  }
  
  /** Creates a new temporalType RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder(other);
  }
  
  /** Creates a new temporalType RecordBuilder by copying an existing temporalType instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder(other);
  }
  
  /**
   * RecordBuilder for temporalType instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<temporalType>
    implements org.apache.avro.data.RecordBuilder<temporalType> {
    ...
    private java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> PeriodOfTime;

    /** Creates a new Builder */
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[7], other.PeriodOfTime)) {
        this.PeriodOfTime = data().deepCopy(fields()[7].schema(), other.PeriodOfTime);
        fieldSetFlags()[7] = true;
      }
    }
    
    /** Creates a Builder by copying an existing temporalType instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'note' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setNote(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearNote() {
      note = null;
    ...
    /** Sets the value of the 'PeriodOfTime' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder setPeriodOfTime(java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType> value) {
    ...
    /** Checks whether the 'PeriodOfTime' field has been set */
    public boolean hasPeriodOfTime() {
      return fieldSetFlags()[7];
    }
    
    /** Clears the value of the 'PeriodOfTime' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.temporalType.Builder clearPeriodOfTime() {
      PeriodOfTime = null;
    ...
    @Override
    public temporalType build() {
      try {
        temporalType record = new temporalType();
        ...
        record.PeriodOfTime = fieldSetFlags()[7] ? this.PeriodOfTime : (java.util.List<com.beligum.blocks.schema.ebucore.v2015.avro.periodOfTimeType>) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
