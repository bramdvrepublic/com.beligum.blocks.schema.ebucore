...
public class UInt64 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public UInt64(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage, java.lang.CharSequence unit) {
  ...
  /** Creates a new UInt64 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder();
  }
  
  /** Creates a new UInt64 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder(other);
  }
  
  /** Creates a new UInt64 RecordBuilder by copying an existing UInt64 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder(other);
  }
  
  /**
   * RecordBuilder for UInt64 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UInt64>
    implements org.apache.avro.data.RecordBuilder<UInt64> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing UInt64 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder setUnit(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.UInt64.Builder clearUnit() {
      unit = null;
