...
public class Boolean16 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Boolean16(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new Boolean16 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder();
  }
  
  /** Creates a new Boolean16 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder(other);
  }
  
  /** Creates a new Boolean16 RecordBuilder by copying an existing Boolean16 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder(other);
  }
  
  /**
   * RecordBuilder for Boolean16 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean16>
    implements org.apache.avro.data.RecordBuilder<Boolean16> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Boolean16 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean16.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public Boolean16 build() {
      try {
        Boolean16 record = new Boolean16();
