...
public class RightsType {
    ...
    protected List<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType> rights;
    @XmlSchemaType(name = "anyURI")
    protected java.lang.String rightsLink;
    protected List<EntityType> rightsHolder;
    protected List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> exploitationIssues;
    protected List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> copyrightStatement;
    ...
    protected List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> disclaimer;
     ...
     * {@link com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType }
     * 
     * 
     */
    public List<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType> getRights() {
        if (rights == null) {
            rights = new ArrayList<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType>();
        }
        return this.rights;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType }
     * 
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> getExploitationIssues() {
        if (exploitationIssues == null) {
            exploitationIssues = new ArrayList<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType>();
        }
     ...
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> getCopyrightStatement() {
        if (copyrightStatement == null) {
            copyrightStatement = new ArrayList<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType>();
        }
     ...
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> getDisclaimer() {
        if (disclaimer == null) {
            disclaimer = new ArrayList<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType>();
        }
