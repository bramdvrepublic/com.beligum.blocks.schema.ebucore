...
public class Float26 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Float26.Builder newBuilder() {
    return new Float26.Builder();
  }
  
  /** Creates a new Float26 RecordBuilder by copying an existing Builder */
  public static Float26.Builder newBuilder(Float26.Builder other) {
    return new Float26.Builder(other);
  }
  
  /** Creates a new Float26 RecordBuilder by copying an existing Float26 instance */
  public static Float26.Builder newBuilder(Float26 other) {
    return new Float26.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Float26>
    ...
    private Builder() {
      super(Float26.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Float26.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Float26.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Float26.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Float26.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Float26.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Float26.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Float26.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Float26.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Float26.Builder clearUnit() {
      unit = null;
