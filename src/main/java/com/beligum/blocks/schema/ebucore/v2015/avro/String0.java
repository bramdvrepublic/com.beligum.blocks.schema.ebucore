...
public class String0 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /**
   * RecordBuilder for String0 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<String0>
    implements org.apache.avro.data.RecordBuilder<String0> {
    ...
    @Override
    public String0 build() {
      try {
        String0 record = new String0();
