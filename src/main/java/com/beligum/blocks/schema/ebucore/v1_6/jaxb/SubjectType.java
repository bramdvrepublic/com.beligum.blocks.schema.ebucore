...
public class SubjectType {
    ...
    protected List<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType> subject;
    @XmlSchemaType(name = "anyURI")
    protected java.lang.String subjectCode;
    protected List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> subjectDefinition;
     ...
     * 
     */
    public List<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType> getSubject() {
        if (subject == null) {
            subject = new ArrayList<com.beligum.blocks.schema.dublincore.simple.v20021212.jaxb.ElementType>();
        }
        return this.subject;
    }
     ...
     * 
     */
    public List<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType> getSubjectDefinition() {
        if (subjectDefinition == null) {
            subjectDefinition = new ArrayList<com.beligum.blocks.schema.ebucore.v1_6.jaxb.ElementType>();
        }
