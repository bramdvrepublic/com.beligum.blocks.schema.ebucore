...
public class Int64 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Int64.Builder newBuilder() {
    return new Int64.Builder();
  }
  
  /** Creates a new Int64 RecordBuilder by copying an existing Builder */
  public static Int64.Builder newBuilder(Int64.Builder other) {
    return new Int64.Builder(other);
  }
  
  /** Creates a new Int64 RecordBuilder by copying an existing Int64 instance */
  public static Int64.Builder newBuilder(Int64 other) {
    return new Int64.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Int64>
    ...
    private Builder(Int64.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Int64.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Int64.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Int64.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Int64.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Int64.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Int64.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Int64.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Int64.Builder clearUnit() {
      unit = null;
