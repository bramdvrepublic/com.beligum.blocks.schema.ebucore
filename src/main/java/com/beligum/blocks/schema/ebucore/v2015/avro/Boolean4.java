...
public class Boolean4 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Boolean4.Builder newBuilder() {
    return new Boolean4.Builder();
  }
  
  /** Creates a new Boolean4 RecordBuilder by copying an existing Builder */
  public static Boolean4.Builder newBuilder(Boolean4.Builder other) {
    return new Boolean4.Builder(other);
  }
  
  /** Creates a new Boolean4 RecordBuilder by copying an existing Boolean4 instance */
  public static Boolean4.Builder newBuilder(Boolean4 other) {
    return new Boolean4.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean4>
    ...
    private Builder() {
      super(Boolean4.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Boolean4.Builder other) {
      super(other);
    ...
    private Builder(Boolean4 other) {
            super(Boolean4.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public Boolean4.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Boolean4.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Boolean4.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Boolean4.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Boolean4.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Boolean4.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Boolean4.Builder clearTypeLanguage() {
      typeLanguage = null;
