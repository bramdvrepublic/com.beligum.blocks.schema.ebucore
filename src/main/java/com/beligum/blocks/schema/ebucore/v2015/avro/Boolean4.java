...
public class Boolean4 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Boolean4(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage) {
  ...
  /** Creates a new Boolean4 RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder();
  }
  
  /** Creates a new Boolean4 RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder(other);
  }
  
  /** Creates a new Boolean4 RecordBuilder by copying an existing Boolean4 instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4 other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder(other);
  }
  
  /**
   * RecordBuilder for Boolean4 instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean4>
    implements org.apache.avro.data.RecordBuilder<Boolean4> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Boolean4 instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4 other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.Boolean4.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    @Override
    public Boolean4 build() {
      try {
        Boolean4 record = new Boolean4();
