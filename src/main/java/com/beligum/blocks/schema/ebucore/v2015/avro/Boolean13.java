...
public class Boolean13 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Boolean13.Builder newBuilder() {
    return new Boolean13.Builder();
  }
  
  /** Creates a new Boolean13 RecordBuilder by copying an existing Builder */
  public static Boolean13.Builder newBuilder(Boolean13.Builder other) {
    return new Boolean13.Builder(other);
  }
  
  /** Creates a new Boolean13 RecordBuilder by copying an existing Boolean13 instance */
  public static Boolean13.Builder newBuilder(Boolean13 other) {
    return new Boolean13.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Boolean13>
    ...
    private Builder() {
      super(Boolean13.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Boolean13.Builder other) {
      super(other);
    ...
    private Builder(Boolean13 other) {
            super(Boolean13.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public Boolean13.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Boolean13.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Boolean13.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Boolean13.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Boolean13.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Boolean13.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Boolean13.Builder clearTypeLanguage() {
      typeLanguage = null;
