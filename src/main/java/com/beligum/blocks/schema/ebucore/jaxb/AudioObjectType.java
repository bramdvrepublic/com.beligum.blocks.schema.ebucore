...
public class AudioObjectType {
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioPackFormatIDRef() {
        if (audioPackFormatIDRef == null) {
            audioPackFormatIDRef = new ArrayList<JAXBElement<String>>();
        }
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioObjectIDRef() {
        if (audioObjectIDRef == null) {
            audioObjectIDRef = new ArrayList<JAXBElement<String>>();
        }
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioComplementaryObjectIDRef() {
        if (audioComplementaryObjectIDRef == null) {
            audioComplementaryObjectIDRef = new ArrayList<JAXBElement<String>>();
        }
     ...
     * 
     */
    public List<JAXBElement<String>> getAudioTrackUIDRef() {
        if (audioTrackUIDRef == null) {
            audioTrackUIDRef = new ArrayList<JAXBElement<String>>();
        }
