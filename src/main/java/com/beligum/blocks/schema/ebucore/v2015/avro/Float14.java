...
public class Float14 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Float14.Builder newBuilder() {
    return new Float14.Builder();
  }
  
  /** Creates a new Float14 RecordBuilder by copying an existing Builder */
  public static Float14.Builder newBuilder(Float14.Builder other) {
    return new Float14.Builder(other);
  }
  
  /** Creates a new Float14 RecordBuilder by copying an existing Float14 instance */
  public static Float14.Builder newBuilder(Float14 other) {
    return new Float14.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Float14>
    ...
    private Builder() {
      super(Float14.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Float14.Builder other) {
      super(other);
    ...
    /** Sets the value of the 'typeLabel' field */
    public Float14.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public Float14.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public Float14.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public Float14.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public Float14.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public Float14.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'unit' field */
    public Float14.Builder setUnit(java.lang.CharSequence value) {
    ...
    public Float14.Builder clearUnit() {
      unit = null;
