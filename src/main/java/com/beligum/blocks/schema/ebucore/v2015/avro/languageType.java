...
public class languageType extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public languageType(java.lang.CharSequence typeLabel, java.lang.CharSequence typeDefinition, java.lang.CharSequence typeLink, java.lang.CharSequence typeSource, java.lang.CharSequence typeNamespace, java.lang.CharSequence typeLanguage, java.lang.CharSequence note, com.beligum.blocks.schema.ebucore.v2015.avro.elementType language) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 7: language = (com.beligum.blocks.schema.ebucore.v2015.avro.elementType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /** Creates a new languageType RecordBuilder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder newBuilder() {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder();
  }
  
  /** Creates a new languageType RecordBuilder by copying an existing Builder */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder(other);
  }
  
  /** Creates a new languageType RecordBuilder by copying an existing languageType instance */
  public static com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder newBuilder(com.beligum.blocks.schema.ebucore.v2015.avro.languageType other) {
    return new com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder(other);
  }
  
  /**
   * RecordBuilder for languageType instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<languageType>
    implements org.apache.avro.data.RecordBuilder<languageType> {
    ...
    private Builder() {
      super(com.beligum.blocks.schema.ebucore.v2015.avro.languageType.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing languageType instance */
    private Builder(com.beligum.blocks.schema.ebucore.v2015.avro.languageType other) {
            super(com.beligum.blocks.schema.ebucore.v2015.avro.languageType.SCHEMA$);
      if (isValidValue(fields()[0], other.typeLabel)) {
        this.typeLabel = data().deepCopy(fields()[0].schema(), other.typeLabel);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'typeLabel' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeLabel(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeLabel() {
      typeLabel = null;
    ...
    /** Sets the value of the 'typeDefinition' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeDefinition(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeDefinition() {
      typeDefinition = null;
    ...
    /** Sets the value of the 'typeLink' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeLink(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeLink() {
      typeLink = null;
    ...
    /** Sets the value of the 'typeSource' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeSource(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeSource() {
      typeSource = null;
    ...
    /** Sets the value of the 'typeNamespace' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeNamespace(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeNamespace() {
      typeNamespace = null;
    ...
    /** Sets the value of the 'typeLanguage' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setTypeLanguage(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearTypeLanguage() {
      typeLanguage = null;
    ...
    /** Sets the value of the 'note' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setNote(java.lang.CharSequence value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearNote() {
      note = null;
    ...
    /** Sets the value of the 'language' field */
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder setLanguage(com.beligum.blocks.schema.ebucore.v2015.avro.elementType value) {
    ...
    public com.beligum.blocks.schema.ebucore.v2015.avro.languageType.Builder clearLanguage() {
      language = null;
    ...
    public languageType build() {
      try {
        languageType record = new languageType();
        ...
        record.language = fieldSetFlags()[7] ? this.language : (com.beligum.blocks.schema.ebucore.v2015.avro.elementType) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
